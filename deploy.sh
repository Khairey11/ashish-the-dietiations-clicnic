...
echo "  Admin password: (the SEED_ADMIN_PASSWORD you set during deployment)"
echo ""
echo "  Client login: sneha@example.com"
echo "  Client password: (the SEED_CLIENT_PASSWORD you set during deployment)"
echo ""
echo "  ⚠️  IMPORTANT: Rotate all passwords after first login!"
echo ""
