...
export const metadata = {
  title: "About Us",
  description: "Meet the clinicians, mission and story behind The Dietitians Clinic — a premium nutrition consultancy transforming lives across South Asia since 2018.",
};
