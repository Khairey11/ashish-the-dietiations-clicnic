            ...
            <div className="grid lg:grid-cols-4 gap-3">
              ...
              <div className="space-y-1 flex flex-col">
                ...
                <div className="flex gap-2 mt-auto">
                  <Button size="sm" onClick={() => save(d.id)} disabled={saving === d.id} className="bg-secondary hover:bg-secondary/90 h-7 text-xs">
  ...
  return (
    <div className="grid sm:grid-cols-3 gap-3">
      ...
      <div className="sm:col-span-3 flex gap-2">
        <Button size="sm" onClick={() => onSave(form)} disabled={!form.name || !form.email || !form.password} className="bg-secondary hover:bg-secondary/90">Create dietitian</Button>
