  ...
  return (
    <>
      <div className="flex items-center justify-between mb-6">
        ...
        <Button size="sm" onClick={() => setShowBuilder(!showBuilder)} className="bg-secondary hover:bg-secondary/90">
      ...
      {showBuilder && (
        <div className="mb-6 p-5 rounded-2xl border border-border/40 bg-card space-y-4">
          ...
          <div className="flex gap-2">
            <Button onClick={createPlan} disabled={saving || !selectedClient || !planTitle} className="bg-secondary hover:bg-secondary/90">
