            ...
            {/* KPI cards */}
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                {[
                  ...
                  { icon: CalendarDays, label: "Today's appts", value: stats ? String(stats.todayAppointments) : null, change: stats ? `${stats.totalAppointments} total` : null, trend: "up", accent: "from-teal-500 to-cyan-500" },
              ...
              {/* Charts row — lazy-loaded (Recharts is ~150KB) */}
              <AdminCharts
                revenueData={stats?.revenueByMonth || []}
                programData={stats?.programData || []}
                leadSourceData={stats?.leadSourceData || []}
              />
