            ...
            <div className="grid lg:grid-cols-4 gap-3">
              ...
              <div className="space-y-1 flex flex-col">
                ...
                <div className="flex gap-2 mt-1">
                  <Button size="sm" onClick={() => save(s.id)} disabled={saving === s.id} className="bg-secondary hover:bg-secondary/90 h-7 text-xs">
  ...
  return (
    <div className="grid sm:grid-cols-3 gap-3">
      ...
      <div className="sm:col-span-3 flex gap-2">
        <Button size="sm" onClick={() => onSave(form)} disabled={!form.slug || !form.title || !form.tagline} className="bg-secondary hover:bg-secondary/90">Create</Button>
