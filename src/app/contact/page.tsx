...
export const metadata = {
  title: "Contact Us",
  description: "Get in touch with The Dietitian’s Center for Clinical & Performance Nutrition. Call, WhatsApp, email, or send us a message — we reply within 1 hour during clinic hours.",
};
