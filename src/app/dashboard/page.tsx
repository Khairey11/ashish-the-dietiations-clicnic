...
import { Calendar, Target, Plus, TrendingDown, Loader2, Activity, Clock, MailCheck, AlertCircle } from "lucide-react";
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div className="p-4 rounded-2xl border border-border/40 bg-card">
            ...
            <div className="h-1.5 bg-muted rounded-full mt-2 overflow-hidden">
              <div className="h-full bg-secondary hover:bg-secondary/90 rounded-full transition-all" style={{ width: `${progressPercent}%` }} />
            </div>
          </div>
        ...
        <div className="p-5 rounded-2xl border border-border/40 bg-card">
          ...
          {showAddWeight && (
            <div className="flex items-end gap-2 mb-4 p-3 rounded-xl bg-muted/30">
              ...
              <Button size="sm" onClick={saveWeight} disabled={!newWeight || savingWeight} className="bg-secondary hover:bg-secondary/90">
          ...
          {chartData.length >= 2 ? (
            ...
            <div className="text-center py-12">
              ...
              <Button size="sm" onClick={() => setShowAddWeight(true)} className="bg-secondary hover:bg-secondary/90">
                <Plus className="w-3.5 h-3.5 mr-1" />
                Log first weight
              </Button>
            </div>
