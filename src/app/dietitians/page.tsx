...
export const metadata = {
  ...
  description: "Meet the RDN-credentialed clinicians behind The Dietitian’s Center for Clinical & Performance Nutrition. Specialists in PMOS, diabetes, sports nutrition, pregnancy and more.",
};
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        description="Every dietitian at The Dietitian’s Center for Clinical & Performance Nutrition is RDN-credentialed, regularly peer-reviewed, and trained in motivational interviewing. You're not just getting a meal plan — you're getting a partner."
