...
export const metadata = {
  ...
  description: "Meet the RDN-credentialed clinicians behind The Dietitians Clinic. Specialists in PMOS, diabetes, sports nutrition, pregnancy and more.",
};
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        description="Every dietitian at The Dietitians Clinic is RDN-credentialed, regularly peer-reviewed, and trained in motivational interviewing. You're not just getting a meal plan — you're getting a partner."
