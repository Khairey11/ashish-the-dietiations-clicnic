        ...
        <div className="flex items-center justify-center p-6 sm:p-12">
          ...
          >
            <div className="lg:hidden mb-8 flex justify-center">
              <Image src="/logo-transparent.png" alt="The Dietitian’s Center for Clinical & Performance Nutrition logo" width={48} height={48} className="w-12 h-12 object-contain" />
            </div>
