  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        title={<>Evidence-based nutrition for <span className="gradient-text">every body</span></>}
        description="From weight management to medical nutrition therapy, our RDN-credentialed clinicians build protocols around your biology, your goals, and your life."
            ...
            {filtered.map((service, i) => (
              ...
              >
                <Link
                  ...
                  className="group block h-full rounded-2xl border border-border/60 bg-card p-6 hover:shadow-premium hover:-translate-y-1 transition-all duration-300"
                >
