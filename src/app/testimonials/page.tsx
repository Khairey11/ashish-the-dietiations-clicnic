...
export const metadata = {
  ...
  description: "Real transformations from The Dietitian’s Center for Clinical & Performance Nutrition — weight loss, PCOS, diabetes, pregnancy and sports nutrition success stories.",
};
