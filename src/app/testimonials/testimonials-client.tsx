  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        description="12,400+ clients have transformed their health with The Dietitian’s Center for Clinical & Performance Nutrition. Here are a few of their stories — unfiltered, verified, and tracked through our platform."
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-5xl mx-auto rounded-3xl bg-gradient-to-br from-primary to-secondary p-8 sm:p-12 text-white text-center shadow-glow">
            ...
            <p className="mt-2 text-white/85 max-w-2xl mx-auto">From PMOS diagnosis to regular cycles and -11 kg — Sneha shares her journey in her own words.</p>
