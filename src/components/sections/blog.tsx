    ...
    <SectionWrapper id="blog" className="bg-background">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <motion.article
          ...
          className="group relative rounded-3xl overflow-hidden border border-border/60 bg-card hover:shadow-premium transition-all duration-300 cursor-pointer"
        >
        ...
        <div className="space-y-4">
          {rest.map((post, i) => (
            <motion.article
              ...
              className="group flex gap-4 p-4 rounded-2xl border border-border/60 bg-card hover:shadow-premium hover:-translate-y-0.5 transition-all duration-300 cursor-pointer"
            >
