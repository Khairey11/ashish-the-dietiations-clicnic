    ...
    <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Share your experience with The Dietitian’s Center for Clinical & Performance Nutrition. What changed for you? How did the team help? (min 20 characters)"
          rows={5}
          required
          minLength={20}
