...
import { GraduationCap, Stethoscope, Microscope, BadgeCheck, BookOpen, MonitorSmartphone } from "lucide-react";

const credentials = [
  { icon: GraduationCap, label: "Bachelor of Nutrition & Dietetics" },
  { icon: Stethoscope, label: "Clinical Dietitian & Nutritionist" },
  { icon: Microscope, label: "Nutrition Researcher" },
  { icon: BadgeCheck, label: "Registered Health Professional" },
