 ...
 *   3. Set FROM_EMAIL=info@thedietitiansclinic.com in .env
 */
    ...
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="background: white; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 12px 12px;">
        ...
        <p style="color: #6b7280; font-size: 15px; line-height: 1.6;">
          Your consultation at The Dietitian’s Center for Clinical & Performance Nutrition has been confirmed. Here are your appointment details:
        </p>
        ...
        <p style="color: #9ca3af; font-size: 12px;">
          The Dietitian’s Center for Clinical & Performance Nutrition — Personalized Nutrition Care<br>
...
export async function sendVerificationEmail(opts: {
  ...
  const html = `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="background: white; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 12px 12px;">
        ...
        <p style="color: #6b7280; font-size: 15px; line-height: 1.6;">
          Welcome to The Dietitian’s Center for Clinical & Performance Nutrition! Please confirm your email address to activate your account and access your dashboard.
        </p>
  ...
  return sendEmail({
    to: opts.to,
    subject: "Verify your email — The Dietitian’s Center for Clinical & Performance Nutrition",
    html,
